...
const forgotPassword = async(req,res)=>{
   ...
   if(!user){
    ...
    res.status(200).send({msg:"A email has been sent to your registered emailId to update your password"})
}
    catch(err){
        console.log(err)
        res.status(500).send({msg:"Internal Server Error"})
...
module.exports = {getAllProfiles, getProfile, updateProfile, forgotPassword, updatePassword}